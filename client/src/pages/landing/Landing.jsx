    ...
    <div className="min-h-screen bg-gradient-to-b from-[#e0e7ff] via-[#ede9fe] to-[#f5f3ff]">
      ...
      <section id="how-it-works" className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="glass-card rounded-2xl p-7 hover:shadow-2xl transition-all shadow-lg">
            <div className="w-12 h-12 mb-4 rounded-xl bg-gradient-to-br from-indigo-500 to-violet-500 flex items-center justify-center shadow-lg">
          ...
          {/* Card 3 */}
          <div className="glass-card rounded-2xl p-7 hover:shadow-2xl transition-all shadow-lg">
            <div className="w-12 h-12 mb-4 rounded-xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-lg">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="12" cy="12" r="10" stroke="#fff" strokeWidth="2" fill="none"/>
